...
public class RecyclerViewLessonsAdapter extends RecyclerView.Adapter<RecyclerViewLessonsAdapter.ViewHolder>{

    private List<Article> list;
    private Context context;

    public RecyclerViewLessonsAdapter(Context context, List<Article> list) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecyclerViewLessonsAdapter.ViewHolder(view);
    }

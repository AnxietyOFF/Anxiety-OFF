...
import br.com.opm.anxietyoff.model.GenericItem;
...
public class RecyclerViewSettingsAdapter extends RecyclerView.Adapter<RecyclerViewSettingsAdapter.ViewHolder> implements Serializable {
    ...
    transient private List<GenericItem> list;
    transient private Context context;

    public RecyclerViewSettingsAdapter(Context context, List<GenericItem> list) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        GenericItem item = list.get(position);
